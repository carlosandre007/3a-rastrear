...
export const CTASection: React.FC = () => {
  return (
    <section id="contato" className="py-24 px-6 bg-white relative overflow-hidden">
      <div className="max-w-5xl mx-auto bg-secondary rounded-[3rem] p-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="https://wa.me/5581985938044?text=Ol%C3%A1!%20Gostaria%20de%20contratar%20o%20rastreamento%20veicular%20da%203A%20Rastrear."
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto px-12 py-5 bg-primary text-secondary font-black text-xl rounded-2xl shadow-2xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
            >
              Contratar Rastreamento
            </a>
            <a
              href="https://wa.me/5581985938044?text=Ol%C3%A1!%20Gostaria%20de%20falar%20com%20um%20especialista%20da%203A%20Rastrear."
              target="_blank"
              rel="noopener noreferrer"
